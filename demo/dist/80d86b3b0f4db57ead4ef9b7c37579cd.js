...
},{"./cjs/react.production.min.js":17,"./cjs/react.development.js":16}],56:[function(require,module,exports) {
/*!
...
},{"is-plain-object":50,"stylis":52,"react":8,"prop-types":51,"hoist-non-react-statics":53}],60:[function(require,module,exports) {
"use strict";
...
var ItemActive = Item.extend(_templateObject4);
...
},{"styled-components":28}],58:[function(require,module,exports) {
"use strict";
...
},{"styled-components":28}],59:[function(require,module,exports) {
"use strict";
...
},{"styled-components":28}],57:[function(require,module,exports) {
"use strict";
...
var _Eg = require("./Eg2.Sidebar");

var _Eg2 = _interopRequireDefault(_Eg);

var _Eg3 = require("./Eg2.Header");

var _Eg4 = _interopRequireDefault(_Eg3);
...
var GridExd = _Grid2.default.extend(_templateObject);

var ConnectedScrollEg2 = function (_React$Component) {
  _inherits(ConnectedScrollEg2, _React$Component);

  function ConnectedScrollEg2() {
    _classCallCheck(this, ConnectedScrollEg2);

    return _possibleConstructorReturn(this, (ConnectedScrollEg2.__proto__ || Object.getPrototypeOf(ConnectedScrollEg2)).apply(this, arguments));
  }

  _createClass(ConnectedScrollEg2, [{
    ...
    value: function render() {
      ...
      var _ConnectedScrollEg2$g = ConnectedScrollEg2.generateData(),
          sidebarData = _ConnectedScrollEg2$g.sidebarData,
          headerData = _ConnectedScrollEg2$g.headerData,
          gridData = _ConnectedScrollEg2$g.gridData;

      console.log(_Parent2.default);
    ...
    value: function generateData() {
      var xArray = Array.from({ length: 30 }, function (e, i) {
        return i;
      });
      var yArray = Array.from({ length: 20 }, function (e, i) {
        return i;
      });
      ...
      var headerRowData = [];
      var gridData = [];
      var gridRowData = void 0;

      yArray.forEach(function (ye, yi) {
        sidebarData.push(yi % 3 === 0 ? _react2.default.createElement(_Eg2.default.ItemActive, { key: yi }) : _react2.default.createElement(_Eg2.default.Item, { key: yi }));

        gridRowData = [];
        xArray.forEach(function (xe, xi) {
          gridRowData.push(xi % 3 === 0 ? _react2.default.createElement(_Grid2.default.ItemActive, { key: xi }) : _react2.default.createElement(_Grid2.default.Item, { key: xi }));

          if (yi === 0) {
            headerRowData.push(_react2.default.createElement(_Eg4.default.Item, { key: xi }));
          }
        });

        gridData.push(_react2.default.createElement(
          _Grid2.default.Row,
          { key: yi },
          gridRowData
        ));
      ...
      return {
        ...
        headerData: _react2.default.createElement(
          _Eg4.default.Row,
          null,
          headerRowData
        ),
      ...
      return _react2.default.createElement(
        ...
        Array.from({ length: 100 }, function (v, i) {
          ...
          return _react2.default.createElement(Area.Item, { key: i });
        })
      );
    }
  }]);

  return ConnectedScrollEg2;
}(_react2.default.Component);

exports.default = ConnectedScrollEg2;
},{"react":8,"../../../../dist":22,"../shared/Parent":20,"../shared/Grid":60,"./Eg2.Sidebar":58,"./Eg2.Header":59}],0:[function(require,module,exports) {
